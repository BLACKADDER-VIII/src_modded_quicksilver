...
OMP_NUM_THREADS=1 LD_PRELOAD=/home/exouser/ANACIN-X/submodules/PnMPI/build/lib/libpnmpi.so PNMPI_LIB_PATH=/home/exouser/ANACIN-X/anacin-x/pnmpi/patched_libs PNMPI_CONF=/home/exouser/ANACIN-X/anacin-x/pnmpi/configs/dumpi_pluto_csmpi.conf mpirun -np 64 /home/exouser/src_modded_quicksilver/src/qs -i /home/exouser/src_modded_quicksilver/Examples/Homogeneous/homogeneousProblem_v5_ts_large.inp --lx=200 --ly=200 --lz=200 --nx=20 --ny=20 --nz=20 --xDom=4 --yDom=4 --zDom=4 --nParticles=100000>& log.txt &&
